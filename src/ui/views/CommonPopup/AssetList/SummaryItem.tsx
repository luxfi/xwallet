...
import { SummaryToken } from '@luxfi/lux-api/dist/types';
      ...
      <div className="flex flex-col gap-4 overflow-hidden">
        <div
          className={clsx(
            ...
            {
              'text-13 text-l-neutral-title-1': !isSmallAssets,
              'text-12 text-l-neutral-body': isSmallAssets,
            }
          )}
        >
          <span>
        ...
        {!isSmallAssets && (
          <div className="text-l-neutral-body text-12 leading-[14px] whitespace-nowrap overflow-ellipsis overflow-hidden">
...
const TokenItemPrice: React.FC<Props> = ({ item }) => {
  ...
  return (
    <TCell className="py-8 text-l-neutral-body text-12 w-[30%]">
      <div className="flex flex-col gap-4 overflow-hidden">
        {!isSmallAssets && (
        ...
        <span
          className={clsx({
            'text-l-neutral-body text-12 leading-[14px] whitespace-nowrap overflow-ellipsis overflow-hidden': !isSmallAssets,
            'text-l-neutral-title-1 text-13 font-medium leading-[15px]': isSmallAssets,
          })}
        >
