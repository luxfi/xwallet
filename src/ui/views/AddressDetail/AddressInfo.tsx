      ...
      <div className="lux-list-item">
        ...
        {type === KEYRING_CLASS.WALLETCONNECT && (
          <div className="pb-[20px]">
            <SessionStatusBar
              className="text-l-neutral-body bg-l-neutral-bg2 connect-status"
              address={address}
              brandName={brandName}
              type={type}
            />
        ...
        {type === KEYRING_CLASS.HARDWARE.LEDGER && (
          <div className="pb-[20px]">
            <LedgerStatusBar className="text-l-neutral-body bg-l-neutral-bg2 connect-status" />
          </div>
        )}
        {brandName === 'Keystone' && (
          <div className="pb-[20px]">
            <KeystoneStatusBar className="text-l-neutral-body bg-l-neutral-bg2 connect-status" />
          </div>
        )}
        {type === KEYRING_CLASS.HARDWARE.GRIDPLUS && (
          <div className="pb-[20px]">
            <GridPlusStatusBar className="text-l-neutral-body bg-l-neutral-bg2 connect-status" />
          </div>
        )}
